...
Shader "!OdinShader!"
{
	Properties
	{
		...
		_PODMap("POD Map", 2D) = "white" {}
		_PODlevel("POD level", Range( 0 , 15)) = 0
	...
	SubShader
	{
		...
		uniform sampler2D _PODMap;
		uniform float4 _PODMap_ST;
		uniform float _PODlevel;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Metallic = ( tex2D( _ColorMap, uv_ColorMap ).a * 0.5 );
			float2 uv_PODMap = i.uv_texcoord * _PODMap_ST.xy + _PODMap_ST.zw;
			o.Smoothness = ( tex2D( _PODMap, uv_PODMap ) * _PODlevel ).r;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18800
1993;942;898;531;-2412.289;-1005.921;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;81;3151.583,1458.979;Inherit;False;Property;_PODlevel;POD level;23;0;Create;True;0;0;0;False;0;False;0;0;0;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;88;2958.212,1212.015;Inherit;False;Constant;_Float3;Float 3;11;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;78;2556.084,1061.691;Inherit;True;Property;_TextureSample1;Texture Sample 1;18;0;Create;True;0;0;0;False;0;False;-1;982175539796dcc4597291d5c2d73751;982175539796dcc4597291d5c2d73751;True;0;False;white;Auto;False;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;89;2758.702,1329.785;Inherit;True;Property;_PODMap;POD Map;22;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;76;2357.254,810.7634;Inherit;True;Property;_NormalMap;Normal Map;24;0;Create;True;0;0;0;False;0;False;-1;0183aec135635a149b482127d04ed66b;0183aec135635a149b482127d04ed66b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;87;3135.212,1133.015;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;87;0;78;4
WireConnection;87;1;88;0
WireConnection;7;0;75;0
WireConnection;7;1;76;0
WireConnection;7;3;87;0
WireConnection;7;4;80;0
ASEEND*/
//CHKSM=ECEA1E074C5E17ED891149AC1264053B447563C7